...
export function Playground(props: PlaygroundProps) {
  ...
  const swiper = useRef<RapierRigidBody | null>(null);
  useEffect(() => {
    ...
    <group {...props} dispose={null}>
      ...
      >
        ...
        >
          <mesh
            ...
            castShadow
            name="Cylinder051"
            geometry={(nodes.Cylinder051 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cylinder051_1"
            geometry={(nodes.Cylinder051_1 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cylinder051_2"
            geometry={(nodes.Cylinder051_2 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cylinder051_3"
            geometry={(nodes.Cylinder051_3 as Mesh).geometry}
      ...
      >
        <mesh
          ...
          geometry={(nodes.gateLargeWide_teamBlue as Mesh).geometry}
      ...
      <RigidBody type="fixed" colliders="trimesh" name="ground">
        <group name="button_teamYellow" position={[-39.612, -0.038, -27.712]}>
          <mesh
            ...
            castShadow
            name="Cube1548"
            geometry={(nodes.Cube1548 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1548_1"
            geometry={(nodes.Cube1548_1 as Mesh).geometry}
        ...
        >
          <mesh
            ...
            castShadow
            name="Cube1559"
            geometry={(nodes.Cube1559 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1559_1"
            geometry={(nodes.Cube1559_1 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1559_2"
            geometry={(nodes.Cube1559_2 as Mesh).geometry}
        ...
        <mesh
          ...
          geometry={(nodes.gateLargeWide_teamYellow as Mesh).geometry}
        ...
        <mesh
          ...
          castShadow
          name="plantA_forest"
          geometry={(nodes.plantA_forest as Mesh).geometry}
        ...
        <mesh
          ...
          castShadow
          name="plantB_forest"
          geometry={(nodes.plantB_forest as Mesh).geometry}
        ...
        <mesh
          ...
          castShadow
          name="rocksB_forest"
          geometry={(nodes.rocksB_forest as Mesh).geometry}
        ...
        <group name="tileHigh_forest" position={[-0.077, -1.023, -15.377]}>
          <mesh
            ...
            castShadow
            name="Cube1600"
            geometry={(nodes.Cube1600 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1600_1"
            geometry={(nodes.Cube1600_1 as Mesh).geometry}
        ...
        <group name="tileLarge_forest" position={[0.014, -1.023, -0.209]}>
          <mesh
            ...
            castShadow
            name="Cube1605"
            geometry={(nodes.Cube1605 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1605_1"
            geometry={(nodes.Cube1605_1 as Mesh).geometry}
        ...
        <group name="tileLarge_teamBlue" position={[-18.017, -1.023, -28.243]}>
          <mesh
            ...
            castShadow
            name="Cube1606"
            geometry={(nodes.Cube1606 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1606_1"
            geometry={(nodes.Cube1606_1 as Mesh).geometry}
        ...
        <group name="tileLarge_teamRed" position={[0.068, -1.023, -21.648]}>
          <mesh
            ...
            castShadow
            name="Cube1607"
            geometry={(nodes.Cube1607 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1607_1"
            geometry={(nodes.Cube1607_1 as Mesh).geometry}
        ...
        <group name="tileLarge_teamYellow" position={[-37.85, -1.023, -27.665]}>
          <mesh
            ...
            castShadow
            name="Cube1608"
            geometry={(nodes.Cube1608 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1608_1"
            geometry={(nodes.Cube1608_1 as Mesh).geometry}
        ...
        <group name="tileLow_forest" position={[-0.145, -1.023, -6.557]}>
          <mesh
            ...
            castShadow
            name="Cube1610"
            geometry={(nodes.Cube1610 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1610_1"
            geometry={(nodes.Cube1610_1 as Mesh).geometry}
        ...
        <group name="tileMedium_teamRed" position={[-11.56, -1.023, -27.446]}>
          <mesh
            ...
            castShadow
            name="Cube1617"
            geometry={(nodes.Cube1617 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1617_1"
            geometry={(nodes.Cube1617_1 as Mesh).geometry}
        ...
        >
          <mesh
            ...
            castShadow
            name="Cube1622"
            geometry={(nodes.Cube1622 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1622_1"
            geometry={(nodes.Cube1622_1 as Mesh).geometry}
        ...
        >
          <mesh
            ...
            castShadow
            name="Cube1624"
            geometry={(nodes.Cube1624 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1624_1"
            geometry={(nodes.Cube1624_1 as Mesh).geometry}
        ...
        >
          <mesh
            ...
            castShadow
            name="Cube1626"
            geometry={(nodes.Cube1626 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cube1626_1"
            geometry={(nodes.Cube1626_1 as Mesh).geometry}
        ...
        <mesh
          ...
          castShadow
          name="tree_desert"
          geometry={(nodes.tree_desert as Mesh).geometry}
        ...
        <group name="tree_forest" position={[-1.828, -0.232, -2.041]}>
          <mesh
            ...
            castShadow
            name="Cylinder067"
            geometry={(nodes.Cylinder067 as Mesh).geometry}
          ...
          <mesh
            ...
            castShadow
            name="Cylinder067_1"
            geometry={(nodes.Cylinder067_1 as Mesh).geometry}
